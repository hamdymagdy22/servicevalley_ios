//
//  companyListByApproved.swift
//  Service Valley
//
//  Created by Mohammed Gamal on 10/29/19.
//  Copyright © 2019 Parth Changela. All rights reserved.
//

import UIKit

class companyListByApproved: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        refresher.addTarget(self, action: #selector (companyListByApproved.handleRefresh), for: UIControl.Event.valueChanged)
    ...
    @objc private func handleRefresh() {
        API.getCompanies2 { (error: Error?, company_list:[companies]?) in
...
guard let has_products = helper.getHas_products() else {return}
    ...
    @objc func handleCompanyTapped(sender: UIButton) {
        ...
        self.performSegue(withIdentifier: "compayDetails", sender: self)
        
        
    }
}

extension companyListByApproved :  UITableViewDataSource {
...
//    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.selectBtn.backgroundColor = UIColor(red: 0.00, green: 0.73, blue: 0.62, alpha: 1.00)
...
//        cell.madmonCheckImage.image = UIImage(named: "check-mark")?.withAlignmentRectInsets(UIEdgeInsets(top: 2, left: 2, bottom: 2, right: 2))
        ...
        cell.companyCell.layer.borderColor = UIColor(red: 0.00, green: 0.73, blue: 0.62, alpha: 1.00).cgColor
