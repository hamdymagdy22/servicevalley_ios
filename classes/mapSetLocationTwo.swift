...
class mapSetLocationTwo: UIViewController , UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        let backButton1 = UIBarButtonItem(title: " عناويني ", style: .plain, target: self, action: #selector(backTapped))
      ...
      navigationItem.leftBarButtonItem?.tintColor = UIColor(red:0.33, green:0.72, blue:0.62, alpha:1.0)
        ...
        chooseBuilding.backgroundColor = UIColor(red:0.06, green:0.72, blue:0.62, alpha:1.0)
    ...
    func keyboardWillShow(notification: NSNotification) {
        ...
        if let keyboardSize = (notification.userInfo?[UIResponder.keyboardFrameBeginUserInfoKey] as? NSValue)?.cgRectValue {
            ...
            UIView.animate(withDuration: 0.3, animations: {
                ...
                self.contentHeightConstraints.constant += self.keyboardHeight
...
extension mapSetLocationTwo : GMSPlacePickerViewControllerDelegate
{
