//
//  nearestCompanies.swift
//  Service Valley
//
//  Created by Mohammed Gamal on 4/22/20.
//  Copyright © 2020 Parth Changela. All rights reserved.
//

import UIKit

class nearestCompanies: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if revealViewController() != nil {
               ...
               refresher.addTarget(self, action: #selector (nearestCompanies.handleRefresh), for: UIControl.Event.valueChanged)
     ...
     @objc private func handleRefresh() {
            API.getCompanies3 { (error: Error?, company_list:[companies]?) in
    ...
    extension nearestCompanies :  UITableViewDataSource {
